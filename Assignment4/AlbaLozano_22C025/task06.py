...
Original file is located at
    https://colab.research.google.com/drive/1u-F5KzyHPqP8E3IVWazMjmNyJru61g_R
...
g.add((ns2.University, RDF.type, RDFS.Class))
for s, p, o in g:
  print(s,p,o)
...
g.add((JaneSmith, ns3.EMAIL, email_address))
...
ns7 = Namespace("http://somewhere")
work_space = Literal("UPM")
g.add((ns.JhonSmith, ns7.WorkSpace, work_space))
