...
Original file is located at
    https://colab.research.google.com/drive/1cVbH_SYoMgjRnzFq2StGQxVF-1cKWUdn
...
g.add((ns.JohnSmith, ns.workspace, ns.UPM))
...
for s, p, o in g.triples((ns.JohnSmith, None, ns.JaneSmith)):
  print(s,p,o)